      ...
      <div class="border border-orange-200 rounded p-3 space-y-2 bg-orange-50">
        ...
        <div class="grid grid-cols-2 gap-2">
          ...
          <div class="space-y-0.5">
            <label class="text-xs text-gray-500">Stat</label>
          ...
          <!-- Size override -->
          <div class="space-y-0.5">
            <label class="text-xs text-gray-500">Size (override)</label>
            <select class="border rounded w-full px-1 py-0.5 text-sm"
        ...
        {#if roll.stat === 'Approval' || roll.stat === 'Recognition' || roll.stat === 'Rizz'}
          <div class="space-y-0.5">
            <label class="text-xs text-gray-500">Player</label>
            <select class="border rounded w-full px-1 py-0.5 text-sm"
              value={roll.target}
        ...
        <!-- Reason -->
        <div class="space-y-0.5">
          <label class="text-xs text-gray-500">Reason (required for positive)</label>
